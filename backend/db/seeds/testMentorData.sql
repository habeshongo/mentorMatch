...
INSERT INTO users (first_name, last_name, email, profile_description, picture, sub, mentor_id, mentee_id)
VALUES
  ('Mike', 'Lee', 'mike.lee@example.com','Data scientist with a passion for leveraging data to solve complex problems. Skilled in various ML techniques.', 'https://images.pexels.com/photos/7562313/pexels-photo-7562313.jpeg?auto=compress&cs=tinysrgb&w=800', '1',1 ,1),
  ('Jessica', 'Smith', 'jessica.smith@example.com', 'Experienced leader with a track record of successful team management and project delivery.','https://images.pexels.com/photos/4902634/pexels-photo-4902634.jpeg?auto=compress&cs=tinysrgb&w=800' ,'2',2 ,2),
  ('Michael', 'Johnson', 'michael.johnson@example.com','Marketing expert with expertise in digital marketing strategies and brand building.','https://images.pexels.com/photos/6652928/pexels-photo-6652928.jpeg?auto=compress&cs=tinysrgb&w=800','3',3 ,3),
  ('Emily', 'Brown', 'emily.brown@example.com','Software engineer specialized in full-stack web development. Strong problem-solving skills.','https://images.pexels.com/photos/6608313/pexels-photo-6608313.jpeg?auto=compress&cs=tinysrgb&w=800','4', 4 ,4),
  ('Robert', 'Davis', 'robert.davis@example.com','Machine Learning Engineer with a strong background in developing cutting-edge AI solutions.','https://images.pexels.com/photos/6147118/pexels-photo-6147118.jpeg?auto=compress&cs=tinysrgb&w=800','5',5 ,5);

-- Now, insert data into the Mentor table
INSERT INTO mentors (mentor_user_id)
VALUES
  (1),
  (2),
  (3),
...
-- Now, insert data into the Mentees table
INSERT INTO mentees (mentee_user_id)
VALUES
  (1),
  (2),
  (3),
